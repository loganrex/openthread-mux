...
#define DT_DRV_COMPAT nordic_nrfx_ieee802154

#define LOG_MODULE_NAME ieee802154_nrf5x
...
#include "ieee802154_nrf5x.h"
#include "nrf_802154.h"
#include "nrf_802154_const.h"

#if defined(CONFIG_NRFX_802154_SER_HOST)
...
#if defined(CONFIG_IEEE802154_NRF5X_UICR_EUI64_ENABLE)
...
#endif /* CONFIG_IEEE802154_NRF5X_UICR_EUI64_ENABLE */

#if defined(CONFIG_IEEE802154_NRF5X_UICR_EUI64_ENABLE)
#define EUI64_ADDR_HIGH CONFIG_IEEE802154_NRF5X_UICR_EUI64_REG
#define EUI64_ADDR_LOW (CONFIG_IEEE802154_NRF5X_UICR_EUI64_REG + 1)
#else
...
#define IEEE802154_NRF5X_VENDOR_OUI CONFIG_IEEE802154_VENDOR_OUI
#else
#define IEEE802154_NRF5X_VENDOR_OUI (uint32_t)0xF4CE36
#endif
...
static void nrf5_get_eui64(uint8_t *mac)
{
	...
	mac[index++] = (IEEE802154_NRF5X_VENDOR_OUI >> 16) & 0xff;
	mac[index++] = (IEEE802154_NRF5X_VENDOR_OUI >> 8) & 0xff;
	mac[index++] = IEEE802154_NRF5X_VENDOR_OUI & 0xff;
...
static void nrf5_rx_thread(void *arg1, void *arg2, void *arg3)
{
	...
	while (1) {
		 ...
		 */
		if (IS_ENABLED(CONFIG_IEEE802154_NRF5X_FCS_IN_LENGTH)) {
...
#if defined(CONFIG_IEEE802154_NRF5X_MULTIPLE_CCA)
...
{
	struct nrf5_802154_data *nrf5_radio = NRF5X_802154_DATA(dev);
...
#if !defined(CONFIG_IEEE802154_NRF5X_EXT_IRQ_MGMT)
...
{
	const struct nrf5_802154_config *nrf5_radio_cfg = NRF5X_802154_CFG(dev);
	struct nrf5_802154_data *nrf5_radio = NRF5X_802154_DATA(dev);
#if defined(CONFIG_IEEE802154_RAW_MODE)
	nrf5_dev = dev;
#endif
			  ...
			  const struct ieee802154_config *config)
{
	...
	case IEEE802154_OPENTHREAD_CONFIG_MAX_EXTRA_CCA_ATTEMPTS:
		...
		break;
#endif /* CONFIG_IEEE802154_NRF5X_MULTIPLE_CCA */
...
void nrf_802154_receive_failed(nrf_802154_rx_error_t error, uint32_t id)
{
	...
	if (IS_ENABLED(CONFIG_IEEE802154_NRF5X_LOG_RX_FAILURES)) {
