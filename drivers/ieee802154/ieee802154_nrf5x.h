/* ieee802154_nrf5x.h - nRF5X 802.15.4 driver */
 ...
 */
#ifndef ZEPHYR_DRIVERS_IEEE802154_IEEE802154_NRF5X_H_
#define ZEPHYR_DRIVERS_IEEE802154_IEEE802154_NRF5X_H_
...
struct nrf5_802154_data {
	...
	/* RX thread stack. */
	K_KERNEL_STACK_MEMBER(rx_stack, CONFIG_IEEE802154_NRF5X_RX_STACK_SIZE);
	 ...
	 */
	struct nrf5_802154_rx_frame rx_frames[CONFIG_NRFX_802154_RX_BUFFERS];
...
#if defined(CONFIG_NRFX_802154_SER_HOST) && defined(CONFIG_IEEE802154_CSL_ENDPOINT)
...
#endif /* CONFIG_NRFX_802154_SER_HOST && CONFIG_IEEE802154_CSL_ENDPOINT */

	/* Indicates if RxOnWhenIdle mode is enabled. */
	bool rx_on_when_idle;
};

#endif /* ZEPHYR_DRIVERS_IEEE802154_IEEE802154_NRF5X_H_ */
